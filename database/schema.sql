...
('SAR-COT-011', 'Teal Blue Green Zari Cotton Saree', 'teal-blue-green-zari-cotton-saree', 'Vibrant green pure cotton saree featuring checks with rich peacock blue zari border and vibrant elephant print blouse piece.', (SELECT id FROM public.categories WHERE slug = 'cotton-sarees'), 1299.00, 1799.00, 28, 'Cotton', 'Green', 'Daily Wear', 15, 'SAR-COT-011', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/11.jpeg', true, true),
('SAR-COT-012', 'Monochrome Grey Checked Handloom Saree', 'monochrome-grey-checked-handloom-saree', 'Elegant grey handloom saree with dark black grid border and contrasting floral black blouse piece.', (SELECT id FROM public.categories WHERE slug = 'cotton-sarees'), 1199.00, 1699.00, 29, 'Cotton', 'Grey', 'Office Wear', 18, 'SAR-COT-012', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/12.jpeg', true, true),
('SAR-SLK-013', 'Royal Purple Gold Zari Weave Silk Saree', 'royal-purple-gold-zari-weave-silk-saree', 'Regal muted purple silk saree with rich gold zari woven border and matching brocade unstitched blouse.', (SELECT id FROM public.categories WHERE slug = 'silk-sarees'), 2299.00, 3499.00, 34, 'Silk', 'Purple', 'Wedding', 10, 'SAR-SLK-013', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/13.jpeg', true, true),
('SAR-COT-014', 'Deep Plum Checked Kalamkari Saree', 'deep-plum-checked-kalamkari-saree', 'Deep plum maroon cotton saree featuring fine zari checks and hand block Kalamkari floral blouse piece.', (SELECT id FROM public.categories WHERE slug = 'cotton-sarees'), 1399.00, 1999.00, 30, 'Cotton', 'Maroon', 'Daily Wear', 20, 'SAR-COT-014', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/14.jpeg', true, false),
