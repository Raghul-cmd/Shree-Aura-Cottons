-- ==============================================================================
-- SHREE AURA COTTONS - COMPLETE BULLETPROOF SUPABASE DATABASE SCHEMA
-- ==============================================================================
...
-- PRODUCTS TABLE (Supports custom Product Codes like 'SAR-COT-001')
...
-- ORDERS TABLE (Supports standard & online payment tracking)
...
-- 8. INITIAL CATEGORIES SEED DATASET (READY FOR FRESH ADMIN ENTRY)
INSERT INTO public.categories (id, name, slug, description, image_url) VALUES
(1, 'Wedding Sarees', 'wedding-sarees', 'Opulent Kanchipuram & Banarasi bridal heirloom collections.', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/2.jpeg'),
(2, 'Office Wear', 'office-wear', 'Elegantly styled, comfortable handloom sarees engineered for professional wear.', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/4.jpeg'),
(3, 'Daily Wear', 'daily-wear', 'Lightweight, elegant, everyday sarees engineered for comfort.', 'https://kuajhwywwvjykxjaaxkg.supabase.co/storage/v1/object/public/product-images/sarees/1.jpeg')
