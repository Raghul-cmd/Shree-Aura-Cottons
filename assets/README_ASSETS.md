# 🖼️ Custom Logo Image Setup Instructions

To replace the fallback monogram text with your official shop logo image:

1. Copy your logo image file from your computer or Google Drive.
2. Rename it to `logo.png` (or `.png` / `.png` transparent background format recommended).
