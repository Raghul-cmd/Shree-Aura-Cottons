...
export const isSupabaseConfigured = () => {
    return SUPABASE_URL &&
        !SUPABASE_URL.includes("https://kuajhwywwvjykxjaaxkg.supabase.co") &&
        SUPABASE_ANON_KEY &&
        !SUPABASE_ANON_KEY.includes("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt1YWpod3l3d3ZqeWt4amFheGtnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY3ODgzNDEsImV4cCI6MjEwMjM2NDM0MX0.hnjYcD2mfUuKzTp9ciLw5FfPp4xLj4p9RmScTgdE12k");
};
